...
<#
This module contains functions for creating linked subscription resource for default provider subscription and enabling remote management on AzureStack. 
...
function Register-AzureStackResourceProvider{
    ...
    [CmdletBinding()]
        ...
        do
        {
            ...
            {
                $DebugPreference="Continue"
                Log-Output "Creating linked subscription resource..."             
                $linkedSubscriptionResource = New-AzureRmResource @resourceCreationParams
    ...
    [CmdletBinding()]
        ...
        try
        {
            $registrationResouce = Get-AzureRmResource -ResourceId $RegistrationResourceId
